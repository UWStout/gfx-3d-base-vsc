...
class AnimatableMesh extends THREE.Mesh {
  ...
  interpolateFrames (requestedFrameNum, prevFrameNum, nextFrameNum, prevTrans, nextTrans) {
    // TODO: Complete this function as follows
    //   - Calculate 'alpha' for linear interpolation
    //   - Call 'lerp' on 'prevTrans' which is implemented in KeyframeTransform
    //   - Pass in the approprate values from the above parameters and 'alpha'
    //   - Return the result of lerp()

    return prevTrans // TODO: Delete this line and return the right value
  }
}
